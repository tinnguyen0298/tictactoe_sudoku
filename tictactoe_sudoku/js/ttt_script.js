 ...
 * Tic-Tac-Toe Game
 */
function sudokuResult(){
  if (isSolved === true){
    window.alert("Game is solved");
  } else {
    window.alert("Oops!");
  }
}
...
//     // game.run();
//     // if (window.gameSolved === true){
//     //   window.alert("Sudoku is solved!");
//     // } else {
//     //   window.alert("Game isnt solved!");
//     // }
//   }
  ...
  for (let i = 1; i <= 9; i++) {
    document.getElementById(i.toString()).addEventListener('click', function() {
      ...
      if (this.innerHTML === "" && !gameEnded) {
        ...
        console.log('isSolved before openForm()' + isSolved);
        openForm();
        console.log("isSolved: " + isSolved); //should be True
        if (isSolved == true){
